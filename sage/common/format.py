...
def time_as_clock(total_seconds, include_centiseconds=False) -> str:
    """
    ...
    """
    hours, minutes, seconds = convert.seconds_to_time_units(total_seconds)
...
def time_in_english(total_seconds) -> str:
    """
    Take a time in total seconds, convert it to the correct time units
